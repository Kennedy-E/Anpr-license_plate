from anpr_class import CannyANPR, EdgelessANPR, SobelANPR
...
# cap = Camera("192.168.0.149", "admin", "admin1")
while True:
    # image = cap.open_video_stream()
    # img = next(image)
    # image = imutils.resize(img, width=400, height=400)
    ...
    if lpText is not None and lpCnt is not None:
        ...
        print("Registration number: {}".format(lpText))
